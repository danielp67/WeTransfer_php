...
<p>Votre fichier a été envoyé avec succès !</p>
   <p>Détail : <br>
       Votre email :<?= htmlspecialchars($viewFile['emailsender']); ?><br>
       Date :<?= $viewFile['date_creation']; ?><br>
       Nom de fichier : <?= $viewFile['zip_name']; ?> <br>
       Nombre de fichiers : <?= $viewFile['file_number']; ?> <br>
       Destinataire : <?= $viewFile['emailreceiver']; ?>  <br><br>
