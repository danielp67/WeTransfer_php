...
function sendMailToRemove($emailsender, $emailreceiver, $zipname)
{
    ...
    $message = (new Swift_Message())
      // Add subject
      ->setSubject($emailreceiver .' a téléchargé votre fichier sur Weezip2.0')
    
      //Put the From address 
     ->setFrom(['weezip@new.com' => 'Sender'])
    
      // Include several To addresses
     ->setTo([$emailsender => 'Receiver'])
      
     ->setBody('<p>Votre fichier a bien été téléchargé sur WeeZip 2.0.</p><br>Pour supprimer le fichier : <a href="http://localhost/TP09_wetransfer_php/index.php?action=deleteFile&zip_name='.$zipname.'">Cliquez ici !</a><br>Sinon il sera automatiquement détruit après 7 jours</p>', 'text/html');
